import { DiscoveryHandler, DiscoveryParams } from '../src/toolHandlers';
...
describe('DiscoveryHandler', () => {
  ...
  describe('execute', () => {
    it('should call discovery API with correct parameters', async () => {
      ...
      (api.discovery as jest.Mock).mockResolvedValue(mockResponse);
    ...
    it('should handle API errors gracefully', async () => {
      ...
      (api.discovery as jest.Mock).mockRejectedValue(mockError);
